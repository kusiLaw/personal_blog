...
RSpec.describe Comment, type: :model do
  context 'Test Comment methods :' do
    it 'Comment should have no comments' do
      user_one = User.create(name: 'Bringht', photo: 'https://unsplash.com/photos/F_-0BxGuVvo',
    ...
    it 'Like should have at least 2 comments' do
      user_one = User.create(name: 'Bringht', photo: 'https://unsplash.com/photos/F_-0BxGuVvo',
                             bio: 'Teacher from Mexico.')
      user_two = User.create(name: 'Lilly', photo: 'https://unsplash.com/photos/F_-0BxGuVvo',
                             bio: 'Teacher from Poland.')
      user_three = User.create(name: 'Peter', photo: 'https://unsplash.com/photos/F_-0BxGuVvo',
                               bio: 'Teacher from Poland.')
